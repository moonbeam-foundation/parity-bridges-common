...
//! EXECUTED COMMAND: target/debug/runtime-codegen --from-node-url ws://127.0.0.1:8800
	...
	pub mod runtime_types {
		...
		pub mod moonbeam_runtime {
			...
			pub enum RuntimeFreezeReason {
				#[codec(index = 20)]
				ParachainStaking(runtime_types::pallet_parachain_staking::pallet::FreezeReason),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
		...
		pub mod polkadot_primitives {
			...
			pub mod vstaging {
				...
				pub struct ClaimQueueOffset(pub ::core::primitive::u8);
				#[derive(
					::codec::Decode,
					::codec::Encode,
					::subxt::ext::subxt_core::ext::codec::CompactAs,
				...
				pub struct CoreSelector(pub ::core::primitive::u8);
			}
		}
