...
//! Types used to connect to the Betanet parachain.
...
impl UnderlyingChainProvider for Betanet {
	type Chain = bp_moonbase::betanet::Betanet;
}
...
impl ChainWithUtilityPallet for Betanet {
	type UtilityPallet = MockedRuntimeUtilityPallet<RuntimeCall>;
}

impl ChainWithTransactions for Betanet {
...
impl ChainWithRuntimeVersion for Betanet {
