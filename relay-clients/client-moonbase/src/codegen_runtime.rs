	...
	pub mod runtime_types {
		...
		pub mod frame_system {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					CodeUpdated,
					#[codec(index = 3)]
					NewAccount { account: ::bp_moonbase::AccountId },
					#[codec(index = 4)]
					KilledAccount { account: ::bp_moonbase::AccountId },
					#[codec(index = 5)]
					Remarked {
						sender: ::bp_moonbase::AccountId,
						hash: ::subxt::ext::subxt_core::utils::H256,
					},
					#[codec(index = 6)]
					UpgradeAuthorized {
		...
		pub mod moonbase_runtime {
			...
			pub mod runtime_params {
				...
				pub mod dynamic_params {
					...
					pub mod pallet_randomness {
						...
						pub enum Parameters {
							#[codec(index = 0)]
                            Deposit(
                                runtime_types::moonbase_runtime::runtime_params::dynamic_params::pallet_randomness::Deposit,
                                ::core::option::Option<
					...
					pub mod runtime_config {
						...
						pub enum Parameters {
                            ...
                            FeesTreasuryProportion(
                                runtime_types::moonbase_runtime::runtime_params::dynamic_params::runtime_config::FeesTreasuryProportion,
                                ::core::option::Option<
					...
					pub mod xcm_config {
						...
						pub enum Parameters {
                            ...
                            ForeignAssetCreationDeposit(
                                runtime_types::moonbase_runtime::runtime_params::dynamic_params::xcm_config::ForeignAssetCreationDeposit,
				...
				pub enum RuntimeParameters {
					#[codec(index = 0)]
                    RuntimeConfig(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::runtime_config::Parameters,
                    ),
                    #[codec(index = 1)]
                    PalletRandomness(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::pallet_randomness::Parameters,
                    ),
                    #[codec(index = 2)]
                    XcmConfig(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::xcm_config::Parameters,
                    ),
                }
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub enum RuntimeParametersKey {
					#[codec(index = 0)]
                    RuntimeConfig(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::runtime_config::ParametersKey,
                    ),
                    #[codec(index = 1)]
                    PalletRandomness(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::pallet_randomness::ParametersKey,
                    ),
                    #[codec(index = 2)]
                    XcmConfig(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::xcm_config::ParametersKey,
                    ),
                }
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub enum RuntimeParametersValue {
					#[codec(index = 0)]
                    RuntimeConfig(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::runtime_config::ParametersValue,
                    ),
                    #[codec(index = 1)]
                    PalletRandomness(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::pallet_randomness::ParametersValue,
                    ),
                    #[codec(index = 2)]
                    XcmConfig(
                        runtime_types::moonbase_runtime::runtime_params::dynamic_params::xcm_config::ParametersValue,
                    ),
                }
			}
			pub mod xcm_config {
			...
			pub enum OriginCaller {
				#[codec(index = 0)]
				system(runtime_types::frame_support::dispatch::RawOrigin<::bp_moonbase::AccountId>),
				#[codec(index = 11)]
				...
				TreasuryCouncilCollective(
					runtime_types::pallet_collective::RawOrigin<::bp_moonbase::AccountId>,
				),
				#[codec(index = 43)]
				Origins(
			...
			pub enum RuntimeCall {
				...
				#[codec(index = 133)]
				BridgeXcmOver(runtime_types::pallet_xcm_bridge::pallet::Call),
				#[codec(index = 134)]
				BridgeXcmRouter(runtime_types::pallet_xcm_bridge_router::pallet::Call),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum RuntimeError {
				...
				#[codec(index = 133)]
				BridgeXcmOver(runtime_types::pallet_xcm_bridge::pallet::Error),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum RuntimeEvent {
				...
				#[codec(index = 133)]
				BridgeXcmOver(runtime_types::pallet_xcm_bridge::pallet::Event),
				#[codec(index = 134)]
				BridgeXcmRouter(runtime_types::pallet_xcm_bridge_router::pallet::Event),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum RuntimeHoldReason {
				...
				#[codec(index = 133)]
				BridgeXcmOver(runtime_types::pallet_xcm_bridge::pallet::HoldReason),
			}
		}
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					mint {
						#[codec(compact)]
						id: ::core::primitive::u128,
						beneficiary: ::bp_moonbase::AccountId,
						#[codec(compact)]
					...
					force_transfer {
						#[codec(compact)]
						id: ::core::primitive::u128,
						source: ::bp_moonbase::AccountId,
						dest: ::bp_moonbase::AccountId,
						#[codec(compact)]
						amount: ::core::primitive::u128,
					},
					#[codec(index = 11)]
					...
					set_team {
						#[codec(compact)]
						id: ::core::primitive::u128,
						issuer: ::bp_moonbase::AccountId,
						admin: ::bp_moonbase::AccountId,
						freezer: ::bp_moonbase::AccountId,
					},
					#[codec(index = 17)]
					set_metadata {
						#[codec(compact)]
					...
					approve_transfer {
						#[codec(compact)]
						id: ::core::primitive::u128,
						delegate: ::bp_moonbase::AccountId,
						#[codec(compact)]
						amount: ::core::primitive::u128,
					},
					#[codec(index = 23)]
					...
					transfer_approved {
						...
						id: ::core::primitive::u128,
						owner: ::bp_moonbase::AccountId,
						destination: ::bp_moonbase::AccountId,
						#[codec(compact)]
						amount: ::core::primitive::u128,
					},
					#[codec(index = 26)]
				...
				pub enum Event {
					...
					Transferred {
						asset_id: ::core::primitive::u128,
						from: ::bp_moonbase::AccountId,
						to: ::bp_moonbase::AccountId,
						amount: ::core::primitive::u128,
					},
					#[codec(index = 3)]
					Burned {
					...
					#[codec(index = 6)]
					Frozen { asset_id: ::core::primitive::u128, who: ::bp_moonbase::AccountId },
					#[codec(index = 7)]
					Thawed { asset_id: ::core::primitive::u128, who: ::bp_moonbase::AccountId },
					#[codec(index = 8)]
					...
					Touched {
						asset_id: ::core::primitive::u128,
						who: ::bp_moonbase::AccountId,
						depositor: ::bp_moonbase::AccountId,
					},
					#[codec(index = 23)]
					Blocked { asset_id: ::core::primitive::u128, who: ::bp_moonbase::AccountId },
					#[codec(index = 24)]
					Deposited {
						asset_id: ::core::primitive::u128,
						who: ::bp_moonbase::AccountId,
		...
		pub mod pallet_author_mapping {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					KeysRegistered {
						nimbus_id: runtime_types::nimbus_primitives::nimbus_crypto::Public,
						account_id: ::bp_moonbase::AccountId,
				...
				pub struct RegistrationInfo {
					pub account: ::bp_moonbase::AccountId,
		...
		pub mod pallet_balances {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					#[codec(index = 6)]
					upgrade_accounts {
						who: ::subxt::ext::subxt_core::alloc::vec::Vec<::bp_moonbase::AccountId>,
					},
					#[codec(index = 8)]
					force_set_balance {
						who: ::bp_moonbase::AccountId,
				...
				pub enum Event {
					#[codec(index = 0)]
					Endowed {
						account: ::bp_moonbase::AccountId,
						free_balance: ::core::primitive::u128,
					},
					#[codec(index = 1)]
					DustLost { account: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 2)]
					Transfer {
						from: ::bp_moonbase::AccountId,
						to: ::bp_moonbase::AccountId,
					...
					#[codec(index = 3)]
					BalanceSet { who: ::bp_moonbase::AccountId, free: ::core::primitive::u128 },
					#[codec(index = 4)]
					Reserved { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 5)]
					Unreserved { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 6)]
					ReserveRepatriated {
						from: ::bp_moonbase::AccountId,
						to: ::bp_moonbase::AccountId,
					...
					#[codec(index = 7)]
					Deposit { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 8)]
					Withdraw { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 9)]
					Slashed { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 10)]
					Minted { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 11)]
					Burned { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 12)]
					Suspended { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 13)]
					Restored { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 14)]
					Upgraded { who: ::bp_moonbase::AccountId },
					#[codec(index = 15)]
					Issued { amount: ::core::primitive::u128 },
					#[codec(index = 16)]
					Rescinded { amount: ::core::primitive::u128 },
					#[codec(index = 17)]
					Locked { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 18)]
					Unlocked { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 19)]
					Frozen { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 20)]
					Thawed { who: ::bp_moonbase::AccountId, amount: ::core::primitive::u128 },
					#[codec(index = 21)]
					TotalIssuanceForced {
		...
		pub mod pallet_bridge_grandpa {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					#[codec(index = 2)]
					set_owner { new_owner: ::core::option::Option<::bp_moonbase::AccountId> },
					#[codec(index = 3)]
					set_operating_mode {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					receive_messages_proof {
						relayer_id_at_bridged_chain: ::bp_moonbase::AccountId,
		...
		pub mod pallet_collective {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					set_members {
						new_members:
							::subxt::ext::subxt_core::alloc::vec::Vec<::bp_moonbase::AccountId>,
						prime: ::core::option::Option<::bp_moonbase::AccountId>,
		...
		pub mod pallet_conviction_voting {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					#[codec(index = 3)]
					unlock { class: ::core::primitive::u16, target: ::bp_moonbase::AccountId },
					#[codec(index = 4)]
					remove_vote {
				...
				pub enum Event {
					#[codec(index = 0)]
					Delegated(::bp_moonbase::AccountId, ::bp_moonbase::AccountId),
					#[codec(index = 1)]
					Undelegated(::bp_moonbase::AccountId),
					#[codec(index = 2)]
					Voted {
						who: ::bp_moonbase::AccountId,
						vote: runtime_types::pallet_conviction_voting::vote::AccountVote<
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					associate_native_identity {
						reward_account: ::bp_moonbase::AccountId,
					...
					change_association_with_relay_keys {
						reward_account: ::bp_moonbase::AccountId,
						previous_account: ::bp_moonbase::AccountId,
					...
					claim,
					#[codec(index = 3)]
					update_reward_address { new_reward_account: ::bp_moonbase::AccountId },
					#[codec(index = 4)]
					...
					initialize_reward_vec {
						rewards: ::subxt::ext::subxt_core::alloc::vec::Vec<(
							[::core::primitive::u8; 32usize],
							::core::option::Option<::bp_moonbase::AccountId>,
							::core::primitive::u128,
						)>,
					},
				}
				...
				pub enum Event {
					#[codec(index = 0)]
					InitialPaymentMade(::bp_moonbase::AccountId, ::core::primitive::u128),
					#[codec(index = 1)]
					...
					#[codec(index = 2)]
					RewardsPaid(::bp_moonbase::AccountId, ::core::primitive::u128),
					#[codec(index = 3)]
					RewardAddressUpdated(::bp_moonbase::AccountId, ::bp_moonbase::AccountId),
					#[codec(index = 4)]
		...
		pub mod pallet_identity {
			...
			pub mod pallet {
				...
				pub enum Call {
					#[codec(index = 0)]
					add_registrar { account: ::bp_moonbase::AccountId },
					#[codec(index = 1)]
					set_identity {
					...
					#[codec(index = 10)]
					kill_identity { target: ::bp_moonbase::AccountId },
					#[codec(index = 11)]
					add_sub {
						sub: ::bp_moonbase::AccountId,
					...
					#[codec(index = 13)]
					remove_sub { sub: ::bp_moonbase::AccountId },
					#[codec(index = 14)]
					quit_sub,
					#[codec(index = 15)]
					add_username_authority {
						authority: ::bp_moonbase::AccountId,
						suffix: ::subxt::ext::subxt_core::alloc::vec::Vec<::core::primitive::u8>,
						allocation: ::core::primitive::u32,
					},
					#[codec(index = 16)]
					remove_username_authority { authority: ::bp_moonbase::AccountId },
					#[codec(index = 17)]
					set_username_for {
						who: ::bp_moonbase::AccountId,
				...
				pub enum Event {
					#[codec(index = 0)]
					IdentitySet { who: ::bp_moonbase::AccountId },
					#[codec(index = 1)]
					IdentityCleared {
						who: ::bp_moonbase::AccountId,
					...
					#[codec(index = 10)]
					AuthorityAdded { authority: ::bp_moonbase::AccountId },
					#[codec(index = 11)]
					AuthorityRemoved { authority: ::bp_moonbase::AccountId },
					#[codec(index = 12)]
					UsernameSet {
						who: ::bp_moonbase::AccountId,
						username: runtime_types::bounded_collections::bounded_vec::BoundedVec<
					...
					#[codec(index = 14)]
					PreapprovalExpired { whose: ::bp_moonbase::AccountId },
					#[codec(index = 15)]
					PrimaryUsernameSet {
						who: ::bp_moonbase::AccountId,
						username: runtime_types::bounded_collections::bounded_vec::BoundedVec<
		...
		pub mod pallet_moonbeam_foreign_assets {
			...
			pub mod pallet {
				...
				pub struct AssetDepositDetails<_0> {
					pub deposit_account: ::bp_moonbase::AccountId,
					pub deposit: ::core::primitive::u128,
					#[codec(skip)]
					pub __ignore: ::core::marker::PhantomData<_0>,
				}
		...
		pub mod pallet_moonbeam_orbiters {
			...
			pub mod pallet {
				...
				pub enum Call {
					#[codec(index = 0)]
					collator_add_orbiter { orbiter: ::bp_moonbase::AccountId },
					#[codec(index = 1)]
					collator_remove_orbiter { orbiter: ::bp_moonbase::AccountId },
					#[codec(index = 2)]
					orbiter_leave_collator_pool { collator: ::bp_moonbase::AccountId },
					#[codec(index = 3)]
					orbiter_register,
					#[codec(index = 4)]
					orbiter_unregister { collators_pool_count: ::core::primitive::u32 },
					#[codec(index = 5)]
					add_collator { collator: ::bp_moonbase::AccountId },
					#[codec(index = 6)]
					remove_collator { collator: ::bp_moonbase::AccountId },
				}
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub enum Error {
					#[codec(index = 0)]
				...
				pub enum Event {
					...
					OrbiterJoinCollatorPool {
						collator: ::bp_moonbase::AccountId,
						orbiter: ::bp_moonbase::AccountId,
					},
					#[codec(index = 1)]
					...
					OrbiterRotation {
						collator: ::bp_moonbase::AccountId,
						old_orbiter: ::core::option::Option<::bp_moonbase::AccountId>,
						new_orbiter: ::core::option::Option<::bp_moonbase::AccountId>,
					},
					#[codec(index = 4)]
					OrbiterRegistered {
						account: ::bp_moonbase::AccountId,
					...
					#[codec(index = 5)]
					OrbiterUnregistered { account: ::bp_moonbase::AccountId },
				}
			}
			pub mod types {
				use super::runtime_types;
		...
		pub mod pallet_multisig {
			...
			pub mod pallet {
				...
				pub enum Event {
					#[codec(index = 0)]
					NewMultisig {
						approving: ::bp_moonbase::AccountId,
						multisig: ::bp_moonbase::AccountId,
						call_hash: [::core::primitive::u8; 32usize],
					},
					#[codec(index = 1)]
					MultisigApproval {
					...
					#[codec(index = 3)]
					MultisigCancelled {
						cancelling: ::bp_moonbase::AccountId,
						timepoint:
							runtime_types::pallet_multisig::Timepoint<::core::primitive::u32>,
						multisig: ::bp_moonbase::AccountId,
						call_hash: [::core::primitive::u8; 32usize],
		...
		pub mod pallet_parachain_staking {
			...
			pub mod pallet {
				...
				pub enum Call {
                    ...
                    #[codec(index = 2)]
                    set_parachain_bond_account { new: ::bp_moonbase::AccountId },
                    #[codec(index = 3)]
                    ...
                    execute_leave_candidates {
                        candidate: ::bp_moonbase::AccountId,
                    ...
                    #[codec(index = 15)]
                    execute_candidate_bond_less { candidate: ::bp_moonbase::AccountId },
                    #[codec(index = 16)]
                    ...
                    #[codec(index = 22)]
                    schedule_revoke_delegation { collator: ::bp_moonbase::AccountId },
                    #[codec(index = 23)]
                    delegator_bond_more {
                        candidate: ::bp_moonbase::AccountId,
                    ...
                    execute_delegation_request {
                        delegator: ::bp_moonbase::AccountId,
                        candidate: ::bp_moonbase::AccountId,
                    },
                    #[codec(index = 26)]
                    cancel_delegation_request { candidate: ::bp_moonbase::AccountId },
                    #[codec(index = 27)]
                    set_auto_compound {
                        candidate: ::bp_moonbase::AccountId,
                    ...
                    #[codec(index = 29)]
                    notify_inactive_collator { collator: ::bp_moonbase::AccountId },
                    #[codec(index = 30)]
				...
				pub enum Event {
                    ...
                    CollatorChosen {
                        round: ::core::primitive::u32,
                        collator_account: ::bp_moonbase::AccountId,
                    ...
                    #[codec(index = 6)]
                    CandidateWentOffline { candidate: ::bp_moonbase::AccountId },
                    #[codec(index = 7)]
                    CandidateBackOnline { candidate: ::bp_moonbase::AccountId },
                    #[codec(index = 8)]
                    ...
                    #[codec(index = 9)]
                    CancelledCandidateExit { candidate: ::bp_moonbase::AccountId },
                    #[codec(index = 10)]
                    ...
                    #[codec(index = 11)]
                    CandidateLeft {
                        ex_candidate: ::bp_moonbase::AccountId,
                    ...
                    #[codec(index = 20)]
                    DelegatorExitCancelled { delegator: ::bp_moonbase::AccountId },
                    #[codec(index = 21)]
		...
		pub mod pallet_parameters {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					set_parameter {
						key_value:
							runtime_types::moonbase_runtime::runtime_params::RuntimeParameters,
					},
				}
				#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
				pub enum Event {
					#[codec(index = 0)]
					Updated {
						key: runtime_types::moonbase_runtime::runtime_params::RuntimeParametersKey,
						old_value: ::core::option::Option<
							runtime_types::moonbase_runtime::runtime_params::RuntimeParametersValue,
						>,
		...
		pub mod pallet_proxy {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					Announced {
						real: ::bp_moonbase::AccountId,
						proxy: ::bp_moonbase::AccountId,
						call_hash: ::subxt::ext::subxt_core::utils::H256,
					},
					#[codec(index = 3)]
					ProxyAdded {
						delegator: ::bp_moonbase::AccountId,
						delegatee: ::bp_moonbase::AccountId,
						proxy_type: runtime_types::moonbase_runtime::ProxyType,
						delay: ::core::primitive::u32,
					},
					#[codec(index = 4)]
		...
		pub mod pallet_sudo {
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					#[codec(index = 2)]
					set_key { new: ::bp_moonbase::AccountId },
					#[codec(index = 3)]
					sudo_as {
						who: ::bp_moonbase::AccountId,
						call: ::subxt::ext::subxt_core::alloc::boxed::Box<
				...
				pub enum Event {
					...
					#[codec(index = 1)]
					KeyChanged {
						old: ::core::option::Option<::bp_moonbase::AccountId>,
						new: ::bp_moonbase::AccountId,
					},
					#[codec(index = 2)]
					KeyRemoved,
			...
			pub mod pallet {
				...
				pub enum Call {
					...
					spend {
						...
						amount: ::core::primitive::u128,
						beneficiary:
							::subxt::ext::subxt_core::alloc::boxed::Box<::bp_moonbase::AccountId>,
		...
		pub mod pallet_xcm_transactor {
			...
			pub mod pallet {
				...
				pub enum Call {
					#[codec(index = 0)]
					register { who: ::bp_moonbase::AccountId, index: ::core::primitive::u16 },
					#[codec(index = 1)]
					...
					transact_through_sovereign {
						dest: ::subxt::ext::subxt_core::alloc::boxed::Box<
							runtime_types::xcm::VersionedLocation,
						>,
						fee_payer: ::core::option::Option<::bp_moonbase::AccountId>,
						fee: runtime_types::pallet_xcm_transactor::pallet::CurrencyPayment<
							runtime_types::moonbase_runtime::xcm_config::CurrencyId,
						>,
				...
				pub enum Event {
                    ...
                    #[codec(index = 2)]
                    TransactedSigned {
                        fee_payer: ::bp_moonbase::AccountId,
                        dest: runtime_types::staging_xcm::v4::location::Location,
                        call: ::subxt::ext::subxt_core::alloc::vec::Vec<
                            ::core::primitive::u8,
                        >,
