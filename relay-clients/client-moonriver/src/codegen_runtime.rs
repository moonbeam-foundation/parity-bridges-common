	...
	pub mod runtime_types {
		...
		pub mod moonriver_runtime {
			...
			pub enum RuntimeCall {
				...
				#[codec(index = 133)]
				BridgeXcmOverMoonbeam(runtime_types::pallet_xcm_bridge_hub::pallet::Call),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum RuntimeError {
				...
				#[codec(index = 133)]
				BridgeXcmOverMoonbeam(runtime_types::pallet_xcm_bridge_hub::pallet::Error),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			pub enum RuntimeEvent {
				...
				#[codec(index = 133)]
				BridgeXcmOverMoonbeam(runtime_types::pallet_xcm_bridge_hub::pallet::Event),
			}
			#[derive(::codec::Decode, ::codec::Encode, Clone, Debug, PartialEq)]
			...
			pub enum RuntimeHoldReason {
				...
				#[codec(index = 133)]
				BridgeXcmOverMoonbeam(runtime_types::pallet_xcm_bridge_hub::pallet::HoldReason),
			}
		}
		...
		pub mod pallet_conviction_voting {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					#[codec(index = 4)]
					VoteUnlocked { who: ::bp_moonriver::AccountId, class: ::core::primitive::u16 },
				}
			}
			pub mod types {
				use super::runtime_types;
