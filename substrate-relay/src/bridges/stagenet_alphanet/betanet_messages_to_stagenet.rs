...
//! Betanet-to-Stagenet messages sync entrypoint.
...
impl SubstrateMessageLane for MessageLane {
	...
	type SourceBatchCallBuilder = UtilityPalletBatchCallBuilder<Betanet>;
	type TargetBatchCallBuilder = UtilityPalletBatchCallBuilder<Stagenet>;
}
